...
//			auto opening_shape_i = std::static_pointer_cast<ManifoldShape>(opening_shapes[i].Shape())->shape();
...
//
//		auto it3_shape = std::static_pointer_cast<ManifoldShape>(it3->Shape())->shape();
//		if (it3_shape.IsNull()) {
...
//		}
//
//		cut_shapes.push_back(IfcGeom::ConversionResult(it3->ItemId(), new ManifoldShape(combined_result), it3->StylePtr()));
//	}
//	return true;
//}
...
//bool IfcGeom::ManifoldKernel::convert_impl(const taxonomy::revolve::ptr r, IfcGeom::ConversionResults& results) {
//
//
//	gp_Ax1 ax(
