...
void ifcopenshell::geometry::ManifoldShape::Triangulate(ifcopenshell::geometry::Settings settings, const ifcopenshell::geometry::taxonomy::matrix4& place, IfcGeom::Representation::Triangulation* t, int item_id, int surface_style_id) const {
...
void ifcopenshell::geometry::ManifoldShape::Serialize(const ifcopenshell::geometry::taxonomy::matrix4& place, std::string&) const {
}

//void ifcopenshell::geometry::ManifoldShape::Serialize(const ifcopenshell::geometry::taxonomy::matrix4& place, std::string& r) const {
...
OpaqueNumber* ifcopenshell::geometry::ManifoldShape::ManifoldShape::length() {
	GProp_GProps prop;
...
std::vector<ConversionResultShape*> ifcopenshell::geometry::ManifoldShape::vertices() {
	...
	for (int i = 1; i <= map.Extent(); ++i) {
        vec.push_back(new ManifoldShape(map.FindKey(i)));
	}
	return vec;
}
...
//            return new ifcopenshell::geometry::ManifoldShape(result);
//		} else {
...
//    return boolean_op(BOPAlgo_FUSE, shape_, ((ifcopenshell::geometry::ManifoldShape*)other)->shape_);
//}
//
//ConversionResultShape* ifcopenshell::geometry::ManifoldShape::subtract(ConversionResultShape* other) {
//    return boolean_op(BOPAlgo_CUT, shape_, ((ifcopenshell::geometry::ManifoldShape*)other)->shape_);
//}
//
//ConversionResultShape* ifcopenshell::geometry::ManifoldShape::intersect(ConversionResultShape* other) {
//    return boolean_op(BOPAlgo_COMMON, shape_, ((ifcopenshell::geometry::ManifoldShape*)other)->shape_);
//}
//
...
//}
//
//ConversionResultShape* ifcopenshell::geometry::ManifoldShape::moved(ifcopenshell::geometry::taxonomy::matrix4::ptr t) const {
//    return new ManifoldShape(IfcGeom::util::apply_transformation(shape_, *t));
//}
//
